...
<script src="<?php echo e(asset('js/sha256.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/sign-message.js')); ?>"></script>
...
<script>
    ...
    document.addEventListener('livewire:navigated', () => {
        const statuses = <?php echo \Illuminate\Support\Js::from($statuses->pluck('id')->values()->toArray())->toHtml() ?>;
...
<?php /**PATH /home/u530748807/domains/app.laboratorioclinicomerino.com/resources/views/vendor/filament-kanban/kanban-scripts.blade.php ENDPATH**/ ?>