...
$orden->observaciones = collect([
    ...
    $unidades = is_array($primero)
        ...
        $pathFl = storage_path('app/public/fl.png');
        $pathIconLab = storage_path('app/public/iconlab.png');
        ...
        $pdf_data = [
            ...
            'fl_b64' => $imgToBase64($pathFl, 380, 220),

            'iconlab_b64' => $imgToBase64($pathIconLab, 380, 380),

            'sello_registro_b64' => $imgToBase64($pathSelloRegistro, 360, 220),
